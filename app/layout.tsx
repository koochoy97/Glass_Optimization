...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "https://viprou.com/wp-content/uploads/2025/08/cropped-ChatGPT-Image-21-ago-2025-08_13_36-p.m.-1-1-1-1.png",
  },
    generator: 'v0.app'
}
    ...
    <html lang="es">
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          ...
          })(window,document,'script','dataLayer','GTM-WCWFHGLG');
        `}
        </Script>
      ...
      <body className={inter.className}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WCWFHGLG"
            height="0"
            width="0"
